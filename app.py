...
def main():
    ...
    # Download model manually at https://huggingface.co/TheBloke/stable-vicuna-13B-GGML/resolve/main/stable-vicuna-13B.ggmlv3.q4_0.bin?download=true
    llm = LlamaCpp(
        model_path="./stable-vicuna-13B.ggmlv3.q4_0.bin",
        stop=["### Human:"],
